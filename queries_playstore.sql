...
-- 4. SELECT app_name, reviews FROM analytics ORDER BY reviews DESC    
...
--10. SELECT * FROM analytics WHERE price BETWEEN .10 AND 1.00 ORDER BY reviews DESC LIMIT 10;
--11. SELECT * FROM analytics ORDER BY last_updated LIMIT 1;
--12. SELECT * FROM analytics ORDER BY price DESC LIMIT 1;
--13. SELECT SUM(reviews) AS "Total Reviews" FROM analytics;
